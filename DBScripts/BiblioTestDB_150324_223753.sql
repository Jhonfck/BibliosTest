...
-- Rules_Group [rel4]
alter table "APP"."RULESSYSTEM"  add column  "OID"  integer;
alter table "APP"."RULESSYSTEM"   add constraint FK_RULESSYSTEM_GROUP foreign key ("OID") references "APP"."GROUP" ("OID");
...
alter table "APP"."RULESSYSTEM"  add column  "COLLECTIONBIBLIOMATERIAL_OID"  integer;
alter table "APP"."RULESSYSTEM"   add constraint FK_RULESSYSTEM_COLLECTIONBIBLI foreign key ("COLLECTIONBIBLIOMATERIAL_OID") references "APP"."COLLECTIONBIBLIOMATERIAL" ("OID");
...
-- Rules_Loan [rel9]
alter table "APP"."RULESSYSTEM"  add column  "LOAN_OID"  integer;
alter table "APP"."RULESSYSTEM"   add constraint FK_RULESSYSTEM_LOAN foreign key ("LOAN_OID") references "APP"."LOAN" ("OID");
