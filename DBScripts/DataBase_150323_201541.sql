...
create table "APP"."BIBLIOMATERIAL" (
   ...
   "DESCRIPTIONMATERIAL"  clob(10000),
  primary key ("OID")
);
...
-- Reserve_User [rel13]
alter table "APP"."RESERVE"  add column  "USER_OID"  integer;
alter table "APP"."RESERVE"   add constraint FK_RESERVE_USER foreign key ("USER_OID") references "APP"."USER" ("OID");


-- Reserve_BiblioMaterial [rel14]
alter table "APP"."RESERVE"  add column  "BIBLIOMATERIAL_OID"  integer;
alter table "APP"."RESERVE"   add constraint FK_RESERVE_BIBLIOMATERIAL foreign key ("BIBLIOMATERIAL_OID") references "APP"."BIBLIOMATERIAL" ("OID");


-- Rules_User [rel15]
alter table "APP"."USER"  add column  "RULES_OID"  integer;
alter table "APP"."USER"   add constraint FK_USER_RULES foreign key ("RULES_OID") references "APP"."RULES" ("OID");


-- Rules_BiblioMaterial [rel16]
alter table "APP"."RULES"  add column  "BIBLIOMATERIAL_OID"  integer;
alter table "APP"."RULES"   add constraint FK_RULES_BIBLIOMATERIAL foreign key ("BIBLIOMATERIAL_OID") references "APP"."BIBLIOMATERIAL" ("OID");
